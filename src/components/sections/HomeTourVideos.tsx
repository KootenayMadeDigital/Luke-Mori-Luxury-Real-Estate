...
export function HomeTourVideos() {
  return (
    <section id="home-tours" className="tone-ivory tonal-section border-y border-[var(--color-line)] py-24 md:py-28">
              ...
              >
                <div className="relative aspect-[16/9] overflow-hidden rounded-[calc(1.5rem-0.25rem)]">
                  ...
                  <div className="absolute inset-x-0 bottom-0 p-5">
                    <div className="text-[11px] font-semibold uppercase tracking-[0.22em] text-[#e5c8a2]">
                      {video.title}
                    </div>
                    <div className="mt-1.5 font-serif text-[22px] font-light leading-[1.15] text-[#f4eadc]">
                      {video.meta}
                    </div>
                  </div>
                </div>
