...
export function SignatureAreas({ preview = false }: SignatureAreasProps) {
  ...
  return (
    <section id="areas" className="tone-lake tonal-section py-24 md:py-28">
      <Container>
        <Reveal className="mb-14 max-w-[760px] md:mb-16">
          ...
          <SectionLede>
            The Kootenays don&apos;t have suburbs. They have areas with different roads,
            sun, shorelines, homes, and daily rhythms. Start here before you tour.
          </SectionLede>
        </Reveal>
        ...
        <div className="grid grid-cols-1 gap-7 md:grid-cols-2 lg:grid-cols-3">
          {areas.map((a, i) => (
            ...
            >
              <div className={`relative overflow-hidden ${preview ? "aspect-[16/8.6]" : "aspect-[16/10]"}`}>
                <Image
                  src={a.image}
                  alt={a.imageAlt}
                  fill
              ...
              <div className={`flex flex-1 flex-col ${preview ? "p-7 sm:p-8" : "p-9 sm:p-10"}`}>
