...
const navGroups: NavGroup[] = [
  {
    ...
    items: [
      ...
      { label: "$1M+ Homes", href: "/listings/luxury", description: "Homes at the top of the market." },
  ...
  },
  {
    ...
    href: "/guides",
    items: [
      { label: "All Guides", href: "/guides", description: "40 plainspoken buyer, seller, and review guides." },
      { label: "Quick Answers", href: "/faq", description: "Common concerns answered without digging." },
