...
export function TemplateRouteLedger() {
  return (
    <section className="tone-ivory tonal-section border-y border-[var(--color-line)] py-28 md:py-32">
      <div
        ...
        aria-hidden
      />
      <div className="pointer-events-none absolute inset-0 bg-[linear-gradient(90deg,var(--color-bg),rgba(251,244,232,0.76),var(--color-bg))]" aria-hidden />
