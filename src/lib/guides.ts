...
export const buyerGuides: BuyerGuide[] = [
  ...
  },
  {
    ...
    checklist: ["Separate emotional value from market evidence", "Compare against active competition and closed sales", "Identify buyer objections before launch", "Prepare the proof that supports the price"],
    ...
    sources: [{ label: "Luke Mori seller representation", href: "/sellers" }, { label: "Luke Mori sold listings", href: "/listings/sold" }],
  },
  {
    slug: "questions-before-hiring-luxury-listing-agent",
    category: "Seller Guides",
    title: "What Sellers Should Ask Before Hiring a Luxury Listing Agent",
    dek: "The questions that reveal whether an agent can price, prepare, market, qualify, and negotiate a high-value property properly.",
    intent: "For sellers interviewing representation before launching a luxury, waterfront, acreage, or unique home.",
    image: headerImages.lukeLeaningPortrait,
    readTime: "6 min read",
    sections: [
      { title: "Ask how the price will be defended", body: ["A luxury listing agent should be able to explain the pricing method, the comparable set, the current competition, and the risks of both overpricing and underpricing. A confident number without a clear argument is not strategy." ] },
      { title: "Ask how the property will be understood", body: ["For unique Kootenay homes, marketing should explain the property, not simply decorate it. Ask about photography, video, copy, floor and room information, local context, buyer objections, and how inquiries will be qualified." ] },
      { title: "Ask what happens after launch", body: ["The launch is only the start. Sellers should understand feedback loops, showing quality, privacy, negotiation posture, offer handling, and when the strategy should change if the market does not respond." ] },
    ],
    checklist: ["Ask for the pricing argument", "Review the marketing plan before signing", "Understand buyer qualification and showing process", "Clarify feedback, privacy, and negotiation strategy"],
  ...
  },
  {
    ...
    dek: "How to prepare land, outbuildings, access, documents, systems, and photography before launching an acreage listing.",
    ...
    sections: [
      ...
      { title: "Prepare the systems story", body: ["Water, septic, road maintenance, snow clearing, heat, outbuildings, drainage, and wildfire mitigation can all affect confidence. Gather service records, maps, permits where available, and clear explanations before launch." ] },
    ...
    questions: ["What parts of the acreage are genuinely usable?", "What systems will buyers ask about first?", "What should be photographed, mapped, or explained before launch?"],
  ...
  },
  {
    ...
    readTime: "7 min read",
    sections: [
      { title: "BC costs and rules need early review", body: ["Buyers should understand property transfer tax, annual property taxes, possible speculation and vacancy tax exposure in designated areas, financing timing, insurance, legal closing process, and any residency or foreign-buyer rules that may apply at the time of purchase.", "Rules change. Treat online guidance as a starting point, then confirm with a BC lawyer or notary, tax advisor, lender, and insurer." ] },
      { title: "Remote due diligence must be organized", body: ["Out-of-area buyers should decide what can be reviewed remotely, what requires an in-person showing, and what needs local professional inspection. Video can help, but it should not replace technical review of water, septic, access, strata, insurance, and title questions." ] },
      { title: "Local context prevents expensive surprises", body: ["The biggest surprises are often practical: winter roads, service distance, trades availability, ferry rhythm, internet, wildfire exposure, and how daily life differs from the buyer's current market." ] },
    ],
    checklist: ["Confirm BC taxes and closing process", "Line up lawyer or notary, lender, insurer, and inspector", "Verify property-specific systems before removing conditions", "Plan a showing route that tests lifestyle and access"],
  ...
  },
  {
    ...
    sections: [
      ...
      { title: "The lifestyle can be excellent if the governance fits", body: ["Shared ownership can provide access and convenience, but it also creates obligations. The question is whether the rules, costs, neighbours, and maintenance structure fit the way you want to use the property." ] },
    ],
  ...
  },
  {
    ...
    dek: "How serious buyers should think about conditions, timing, proof, negotiation, and emotional discipline on unique properties.",
    intent: "For buyers preparing to write on a high-value home where the comparison set is not simple.",
    image: headerImages.nelsonLandscape,
    readTime: "6 min read",
    sections: [
