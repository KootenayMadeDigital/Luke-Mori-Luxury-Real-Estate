...
export const buyerGuides: BuyerGuide[] = [
  ...
  },
  {
    ...
    intent: "For sellers deciding how a Kootenay property should be prepared before listing.",
  ...
  },
  {
    ...
    sections: [
      ...
      { title: "Presentation affects buyer confidence", body: ["Strong photography, video, property pages, room details, documents, and area context help buyers understand why the property deserves attention. Weak presentation makes even the right price feel uncertain." ] },
    ],
  ...
  },
  {
    ...
    dek: "The questions that reveal whether an agent can price, prepare, market, screen, and negotiate a property properly.",
  ...
  },
  {
    ...
    intent: "For buyers preparing to write on a home where the comparison set is not simple.",
    image: "/generated/guide-headers/offer-strategy-luxury-homes-nelson-kootenay-lake.webp",
    readTime: "6 min read",
    sections: [
      { title: "The right offer starts before the form", body: ["A strong offer is built from preparation: financing, legal advice, inspection plan, understanding of the seller's timing, and a clear view of what must be verified. The paperwork should reflect decisions already made, not create them in a rush." ] },
  ...
  },
  {
    ...
    sections: [
      ...
      { title: "Use matters too", body: ["Tax exposure can depend on ownership, residency, use, rental, exemptions, and reporting obligations. A realtor can help frame the property question, but a buyer should confirm tax treatment with official provincial sources and tax advice."] },
...

  {
    ...
    sections: [
      ...
      { title: "Compare homes by annual reality", body: ["Two homes at the same purchase price can feel very different after tax, insurance, utilities, access, and maintenance. Carrying costs make the shortlist more honest."] },
    ],
  ...
  },
  {
    ...
    intent: "For buyers considering homes where systems, water, slope, access, or age make the inspection matter more.",
    ...
    sections: [
      ...
      { title: "Specialists answer specialist questions", body: ["A good inspection plan asks who should answer each risk. A home inspector, septic professional, well specialist, structural engineer, roofer, insurer, and local authority may all have different roles."] },
  ...
  },
  {
    ...
    intent: "For families handling inherited, long-held, waterfront, acreage, or emotionally meaningful properties.",
    image: "/generated/guide-headers/estate-legacy-property-sale-kootenays.webp",
    readTime: "7 min read",
    sections: [
      { title: "Legacy sales need patience and structure", body: ["A long-held property can carry family history, deferred decisions, incomplete documents, and multiple voices. The sale plan should create order before the property reaches the market."] },
  ...
  },
  {
    ...
    dek: "How seasonality, photography, lake access, snow, buyer travel, and preparation affect listing timing.",
    ...
    sections: [
      ...
      { title: "Preparation can matter more than the month", body: ["A rushed listing in the right season can still underperform. Documents, cleanup, repairs, photography, film, pricing, and buyer targeting should be ready before the home goes public."] },
      { title: "Buyer travel shapes showing quality", body: ["Waterfront, acreage, and second-home buyers may need time to travel. A good sale plan respects that timing and gives buyers enough information to make showings serious."] },
    ],
  ...
  },
  {
    ...
    dek: "What makes a Nelson home valuable: setting, views, privacy, architecture, access, land, systems, and resale confidence.",
    intent: "For buyers searching Nelson BC luxury homes, lake-view homes, acreage estates, and Kootenay properties that need extra care.",
    image: "/generated/guide-headers/nelson-bc-luxury-homes-guide.webp",
    readTime: "7 min read",
    sections: [
      { title: "Luxury is not only finish level", body: ["In Nelson, homes often earn their value through setting: Kootenay Lake views, walkability, privacy, sun, architecture, land, guest space, shops, gardens, or rare access. Fine finishes help, but the location and daily life usually carry the value."] },
      ...
      { title: "Resale confidence comes from understanding", body: ["A strong purchase is easier to defend when the setting, condition, comparable sales, buyer depth, and future use are understood. The more unique the home, the more the explanation matters."] },
    ],
  ...
  },
  {
    ...
    dek: "How to prepare, price, explain, and protect the sale of a Nelson home without turning the process into noise.",
    ...
    sections: [
      ...
      { title: "Preparation builds confidence", body: ["Before listing, gather useful documents, service history, upgrade notes, floor and room information, utility context, access details, and anything a careful buyer will ask about. This matters especially for older homes, view properties, acreage, waterfront, and homes with guest space or suites."] },
    ...
    checklist: ["Define the likely buyer and objections", "Prepare documents before photography", "Build a pricing argument from evidence", "Protect privacy while giving serious buyers enough information"],
